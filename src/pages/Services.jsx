export default function Services() {
  return (
    <>
      <section className="page-hero py-5" aria-labelledby="services-hero">
      ...
      <section className="service-list py-5" aria-label="Lista serviciilor principale">
        <div className="container service-grid detailed">
          <article className="service-card" id="web-design">
          ...
          <article className="service-card" id="seo">
            <div className="service-icon">
            ...
            <a className="link-arrow" href="/contact">
              Solicită un audit SEO
            </a>
          </article>
          <article className="service-card" id="social-media">
            <div className="service-icon">
            ...
            <a className="link-arrow" href="/contact">
              Planifică o campanie
            </a>
          </article>
          <article className="service-card" id="branding">
            <div className="service-icon">
      ...
      <section className="service-process py-5" aria-labelledby="process-title">
      ...
      <section className="cta-banner py-5" aria-labelledby="cta-services">
